...
function AppContent() {
  ...
  const encodeUrl = useCallback(() => {
    ...
    const filterQuery = todoState.queryString
      ? `&filterByFormula=SEARCH("${todoState.queryString}", {title})`
      : "";

    return encodeURI(`${url}?${sortQuery}${filterQuery}`);
  }, [
    todoActions.queryString,
    todoActions.sortDirection,
    todoActions.sortField,
  ]);
